...
const PILL_PALETTES = [
  { bg: "oklch(0.94 0.04 255)", text: "oklch(0.42 0.14 255)" }, // violet
    ...
    <div className="flex h-full overflow-hidden bg-[#F8F8FC] text-[var(--text-primary)] antialiased">
      ...
      <main className="flex-1 overflow-y-auto bg-[#F8F8FC] px-6 py-8 pb-24 md:px-[52px] md:py-[44px] md:pb-[64px]">
        <div className="max-w-[680px]">
          ...
          <header className="mb-6 md:mb-7">
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                ...
                className="flex-shrink-0 flex items-center gap-[7px] px-[14px] py-[9px] text-[13px] font-semibold text-white bg-[var(--violet)] rounded-[10px] border-none cursor-pointer hover:opacity-90 transition-opacity shadow-[0_4px_12px_-3px_oklch(0.58_0.16_255_/_0.45)]"
              >
              ...
              return (
                <button
                  ...
                  className={`px-[14px] py-[6px] rounded-full text-[13px] font-medium transition-all border cursor-pointer ${
                    filter === tab
                      ? "bg-[var(--violet)] text-white border-[var(--violet)] shadow-[0_2px_8px_-2px_oklch(0.58_0.16_255_/_0.4)]"
                      : "bg-white text-[var(--text-secondary)] border-[var(--border)] hover:border-[oklch(0.80_0.08_255)] hover:text-[var(--violet)]"
                  }`}
                >
          ...
          {/* Inline add form */}
          {addingTask && (
            <div className="bg-white border border-[var(--violet)] rounded-[14px] p-4 flex flex-col gap-3 mb-5 shadow-[0_4px_20px_-6px_oklch(0.58_0.16_255_/_0.22)]">
              <input
                autoFocus
                type="text"
                value={newTitle}
  ...
  return (
    <div className="flex flex-col items-center gap-4 py-16 text-center">
      <div className="w-12 h-12 rounded-[14px] bg-[var(--violet-active)] flex items-center justify-center">
        <svg width="22" height="22" viewBox="0 0 18 18" fill="none" stroke="oklch(0.58 0.16 255)" strokeWidth="1.7">
